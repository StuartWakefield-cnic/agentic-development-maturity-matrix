...
export default function ResultsSection({ dimensions, levelNames, scores, overall, attainedMin }) {
  ...
  return (
    <section id="results">
      <div className="wrap">
        <div className="sec-eyebrow">Evaluation</div>
        <h2>Your maturity matrix</h2>
        <p className="lede">
        ...
        <div className="results-grid">
          <div className="panel">
            ...
            <div className="radar-legend">
              <span>
                <span className="sw" style={{ background: "var(--pine)" }} />
                Attained level
              </span>
              <span>
                <span className="sw" style={{ background: "var(--pine-mid)", opacity: 0.55 }} />+ partial progress
              </span>
            </div>
